        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <img alt="image" class="" src="images/smshetty-small.jpg"/>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <span class="block m-t-xs font-bold"><?php echo $_SESSION['smshetty_adm_us_nm']; ?></span>
                ...
                <div class="logo-element">
                    <img src="images/smshetty-small.png" class="img img-responsive">
                </div>
            </li>
            <li>
